    ...
    <ParallaxSection variant="shop">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-6 sm:mb-10">
          <h2 className="font-display text-2xl sm:text-3xl md:text-4xl text-secondary-foreground mb-2">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
          {stats.map((stat, index) => (
            <GlassCard key={index} className="!p-4 sm:!p-6 text-center">
              <div className="font-display text-2xl sm:text-3xl md:text-4xl text-accent mb-1">
                {stat.value}
              </div>
