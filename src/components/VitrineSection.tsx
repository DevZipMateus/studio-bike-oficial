      ...
      <div className="container-custom relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 bg-secondary hover:bg-secondary/90 text-secondary-foreground px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300"
              >
                Falar com vendedor
              </a>
            </div>
          ...
          <div className="relative">
            <div className="card-elevated p-2 rounded-2xl bg-background">
              ...
              <div className="flex items-center gap-2 px-4 py-3 border-b border-border">
                ...
                <div className="flex-1 mx-4">
                  <div className="bg-muted rounded-md px-3 py-1.5 text-xs text-muted-foreground truncate">
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-b-xl">
                ...
                >
                  <span className="bg-accent text-accent-foreground px-6 py-3 rounded-lg font-semibold opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-2">
            ...
            {/* Decorative elements */}
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-highlight/20 rounded-xl -z-10" />
